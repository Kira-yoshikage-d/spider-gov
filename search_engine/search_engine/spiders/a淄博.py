...
class A淄博Spider(ZhengFuBaseSpider):
    name: str = '淄博'
    api: str = 'http://www.zibo.gov.cn/jsearchfront/interfaces/cateSearch.do'
    method: str = 'POST'
    ...
    def edit_item(self, item: Any) -> Optional[dict[str, Union[str, int]]]:
        ...
        result = {
            ...
            'url':  item.css("div.jcse-news-other-info a::text").get(),
            'type': item.css("div.jcse-news-title span::text").get(),
            'date': item.css("div.jcse-news-other-info span::text").get()
        }
        return result

...
class A青海省生态环境厅Spider(ZhengFuBaseSpider):
    name: str = '青海省生态环境厅'
    api: str = 'https://sthjt.qinghai.gov.cn/igs/front/search.jhtml?code=1894c5dedae64ce3aef767e8140c7e08&pageNumber={page}&pageSize=10&searchWord={keyword}&siteId=8'
    method: str = 'GET'
    data: dict[str, Any] = {}
    debug: bool = False
